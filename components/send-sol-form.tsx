...
import { RiSendPlaneLine, RiRefreshLine, RiInformationLine, RiGlobalLine } from '@remixicon/react';
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-800">
            ...
            <ul className="text-xs space-y-1">
              <li>• Ensure you have sufficient SOL for the transfer amount + transaction fees</li>
