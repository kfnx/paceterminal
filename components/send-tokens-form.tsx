...
import { RiSendPlaneLine, RiRefreshLine, RiWallet3Line, RiInformationLine } from '@remixicon/react';
        ...
        <Input.Root>
          <Input.Wrapper>
            <Input.Input
              type="text"
              value={tokenMint}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleTokenMintChange(e.target.value)}
